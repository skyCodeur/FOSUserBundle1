...
class __TwigTemplate_bcac0b6b6736e43bc1a530a8d6c24bfdcffd156500b2a1def34cbb6db0e4d9e8 extends Twig_Template
{
    ...
    <body>
        <div>
            {% if is_granted(\"IS_AUTHENTICATED_REMEMBERED\") %}
                ...
                <a href=\"{{ path('fos_user_security_logout') }}\"> Deconnexion 
                    {{ 'logout'|trans({}, 'FOSUserBundle') }}
                </a>
            {% else %}
                <a href=\"{{ path('fos_user_security_login') }}\">connexion {{ 'login'|trans({}, 'FOSUserBundle') }} </a>
            {% endif %}
        </div>
...
", "FOSUserBundle::layout.html.twig", "C:\\wamp\\www\\symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\views\\layout.html.twig");
    }
}
